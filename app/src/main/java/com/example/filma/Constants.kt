...
const val SEARCH_BY_NAME_LIST = "movie?field=name"
const val NEW_RELEASES_LIST = "movie?field=year&search=2020-2022&sortField=year&sortType=-1&sortField=votes.imdb&sortType=-1"
const val TAG = "TAG"
